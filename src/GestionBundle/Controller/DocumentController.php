...
class DocumentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $documents = $em->getRepository('GestionBundle:Document')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('GestionBundle\Form\DocumentType', $document);
    ...
    {
        $deleteForm = $this->createDeleteForm($document);
        $editForm = $this->createForm('GestionBundle\Form\DocumentType', $document);
     ...
     *
     * @Route("/delete/{id}",options={"expose"=true}, name="document_delete")
     * @Method("post")
     */
    public function deleteAction($id)
    {
        $em = $this->getDoctrine()->getManager();
        $document = $em->getRepository('GestionBundle:Document')->find($id);
