...
use GestionBundle\Entity\Groupe;
...
class GroupeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $groupes = $em->getRepository('GestionBundle:Groupe')->findAll();
    ...
    {
        $groupe = new Groupe();
        $form = $this->createForm('GestionBundle\Form\GroupeType', $groupe);
     ...
     *
     * @Route("show/{id}", name="groupe_show")
     * @Method("GET")
     */
    ...
    {
        $deleteForm = $this->createDeleteForm($groupe);
        $editForm = $this->createForm('GestionBundle\Form\GroupeType', $groupe);
    ...
    {
        $em = $this->getDoctrine()->getManager();
        $group = $em->getRepository('GestionBundle:Groupe')->find($id);
        $em = $this->getDoctrine()->getManager();
        $em->remove($group);
        $em->flush($group);
        $this->addFlash(
