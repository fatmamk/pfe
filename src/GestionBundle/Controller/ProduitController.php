...
class ProduitController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $produits = $em->getRepository('GestionBundle:Produit')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        //$produit->setNom('mlika');
        //$produit->setDescription('bonjour');
    ...
    {
        $deleteForm = $this->createDeleteForm($produit);
        $editForm = $this->createForm('GestionBundle\Form\ProduitType', $produit);
